...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(17), __webpack_require__(51)))
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__bootstrap_js__ = __webpack_require__(77);
...
var api = {
    ...
    checkLogin: function checkLogin() {
        return axios.get('passport/checkLogin', { withCredentials: true });
    },
    ...
    getUserDetail: function getUserDetail(data) {
        return axios.get('user/show', { params: data });
    },

    // 修改用户信息
    updateUser: function updateUser(data) {
        return axios.post('user/update/' + data.id, data);
    },

    // 删除用户
    destoryUser: function destoryUser(data) {
        return axios.post('user/update/' + data.id);
    },
    ...
    updateCategory: function updateCategory(data) {
        return axios.post('category/update/' + data.id, data);
    },

    // 删除类别
    deleteCategory: function deleteCategory(data) {
        return axios.post('category/destroy/' + data.id);
    },

    // 获取标签
    getAllTag: function getAllTag(data) {
        return axios.get('tag/list', { params: data });
    },
    ...
    updateTag: function updateTag(data) {
        return axios.post('tag/update/' + data.id, data);
    },

    // 删除标签
    destroyTag: function destroyTag(data) {
        return axios.post('tag/destroy/' + data.id);
    },
    ...
    deleteArticle: function deleteArticle(data) {
        return axios.post('post/destroy/' + data.id);
    },

    // 更新文章
    updateArticle: function updateArticle(data) {
        return axios.post('post/update/' + data.id, data);
    },
    ...
    imgUpload: function imgUpload(data) {
        return axios.get('post/upload/file', { params: data });
    }
};
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(17), __webpack_require__(100).setImmediate))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Home_vue__ = __webpack_require__(298);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__router_home__ = __webpack_require__(203);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__store_home__ = __webpack_require__(302);
...
var update = __webpack_require__(49)("52c37839", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api_admin__ = __webpack_require__(194);
...
var actions = {
	...
	getArticleList: function getArticleList(_ref5, data) {
		...
		var params = data ? _extends({}, pageParams, { query: data.query, queryid: data.id }) : pageParams;

		__WEBPACK_IMPORTED_MODULE_2__api_admin__["a" /* default */].getArticleList(params).then(function (res) {
			if (res.data.code === 200) {
				var d = res.data.data;
				if (d && d.dataList) {
					commit({
